...
public enum EhdsiErrorCode implements ErrorCode {
    ...
    EHDSI_ERROR_NOT_VALID_ASSERTION("1001", "Assertion is not valid."),
    EHDSI_ERROR_NOT_VALID_TRC_ASSERTION("1002", "The given TRC Assertion does not validate against the Identity Assertion"),
    EHDSI_ERROR_EP_NOT_FOUND("1101", "No ePrescription is registered for the given patient. "),
    EHDSI_ERROR_PS_NOT_FOUND("1102", "No PS is registered for the given patient."),
    EHDSI_ERROR_MRO_NO_DATA("1103", "No Data for MRO"),
    EHDSI_ERROR_ORCD_NOT_FOUND("1104", "No ORCD document is registered for the given patient."),
    EHDSI_ERROR_DOCUMENT_NOT_FOUND("1100", "No documents are registered for the given patient."),
    EHDSI_ERROR_DOCUMENT_NOT_PROCESSED("2201", "Documents were received but not processed"),
    EHDSI_ERROR_RENDERING_INCOMPLETE("4101", "Rendering Incomplete"),
    EHDSI_ERROR_COLLECTION_INCOMPLETE("4102", "Collection incomplete "),
    EHDSI_ERROR_EP_REGISTRY_NOT_ACCESSIBLE("4103", "ePrescription registry could not be accessed."),
    EHDSI_ERROR_EP_NOT_AVAILABLE("4104", "Data Accesss Failure"),
    EHDSI_ERROR_EP_NOT_MATCHING("4105", "No matching ePrescription was found"),
    EHDSI_ERROR_EP_ALREADY_DISPENSED("4106", "ePrescription has already been dispensed"),
    EHDSI_ERROR_ORIGINAL_DATA_MISSING("4107", "For data of the given kind the Provide Data service provider requires the service consumer to transmit the source coded PDF document."),
    EHDSI_ERROR_PIVOT_MISSING("4108", "The service consumer did not provide the eHealth DSI pivot coded document which is requested by the Provide Data service provider for the given kind of data. "),
    EHDSI_ERROR_UNSUPPORTED_FEATURE("4201", "If PDF-coded document is requested: Country A does not provide the (optional) source coded version of the document "),
    EHDSI_ERROR_UNKNOWN_SIGNIFIER("4202", "The query argument slots used by the service consumer are not supported by the service provider. "),
    EHDSI_ERROR_TRANSCODING_ERROR("4203", "The requested encoding cannot be provided due to a transcoding error. "),
    EHDSI_ERROR_UNKNOWN_FILTER("4204", "The service provider is unable to evaluate the given argument values"),
    EHDSI_ERROR_UNKNOWN_OPTION("4205", "The service provider does not implement the On Demand Documents option as requested by the service consumer."),
    EHDSI_ERROR_UNKNOWN_PATIENT_IDENTIFIER("4206", "The patient identifier in the query differs from the patient identifier in the TRC assertion"),
