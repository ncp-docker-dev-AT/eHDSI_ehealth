...
public final class TMServices {
    ...
    public static byte[] transformDocument(byte[] document, String language) throws DocumentTransformationException {
        ...
        if (!tmResponse.isStatusSuccess()) {
            throw new DocumentTransformationException(EhiErrorCode.XDSRepositoryError, EhdsiErrorCode.EHDSI_ERROR_TRANSLATE_GENERIC, Constants.SERVER_IP,"An error has occurred during document translation, please check the following errors:\n"
