...
public class TestConstants {
    ...
    public static void checkEnvironmentVariables() {
        logger.info(EPSOS_PROPS_PATH_NAME + ": " + System.getenv(EPSOS_PROPS_PATH_NAME));
        if (System.getenv(EPSOS_PROPS_PATH_NAME) == null) {
            logger.info(EPSOS_PROPS_PATH_NAME + " is not set, using: " + TestConstants.EPSOS_PROPS_PATH);
