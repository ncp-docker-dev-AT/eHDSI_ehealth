...
public class XCPD_ServiceSkeletonIT extends ServerGenericIT {
    ...
    public void testQuery() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#0.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryIdOnly() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#1.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryDemographicsOnly() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#2.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryEHICardOnly() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#3.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryPrivateData() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#4.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryInsRights() {
        this.assertions = hcpAssertionCreate(new ArrayList<String>(0), XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryPatientAuthId() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#6.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryMinAccur() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#7.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryInvalidTraits() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#8.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryConfConflict() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#9.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testBadLivingSubjectID() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#10.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testGoodLivingSubjectID() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#10.1.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testBadLivingSubjectName() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#11.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testGoodLivingSubjectName() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#11.1.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testBadLivingSubjectBirthTime() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#12.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testGoodLivingSubjectBirthTime() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#12.1.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testBadLivingSubjectGender() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#13.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testGoodLivingSubjectGender() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#13.1.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testBadLivingSubjectBirthPlaceAddress() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#14.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testGoodLivingSubjectBirthPlaceAddress() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#14.1.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testBadpatientAddress() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#15.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testGoodpatientAddress() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#15.1.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testInvalidField() {
        this.assertions = this.getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#16.xml", XSPARole.DEPRECATED_PHYSICIAN);
