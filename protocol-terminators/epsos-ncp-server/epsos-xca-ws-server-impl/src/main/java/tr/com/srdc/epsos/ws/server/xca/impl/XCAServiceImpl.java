...
public class XCAServiceImpl implements XCAServiceInterface {
    ...
    private RegistryError createErrorMessage(String errorCode, String codeContext, String value, RegistryErrorSeverity severity) {
    ...
    private void adhocQueryResponseBuilder(AdhocQueryRequest request, AdhocQueryResponse response, SOAPHeader soapHeader,
        ...
        if (!SAML2Validator.isConsentGiven(patientId, countryCode)) {
            addErrorMessage(registryErrorList, EhdsiErrorCode.EHDSI_ERROR_NO_CONSENT, EhdsiErrorCode.EHDSI_ERROR_NO_CONSENT.getDescription(), "", RegistryErrorSeverity.ERROR_SEVERITY_ERROR);
        }

        if (classCodeValues.isEmpty()) {
            addErrorMessage(registryErrorList, EhdsiErrorCode.EHDSI_ERROR_UNKNOWN_SIGNIFIER, "Class code missing in XCA query request.", "", RegistryErrorSeverity.ERROR_SEVERITY_ERROR);
        }
            ...
            switch (classCodeValue) {
                case Constants.EP_CLASSCODE:
                    ...
                    if (prescriptions == null) {
                        ...
                        addErrorMessage(registryErrorList, EhdsiErrorCode.EHDSI_ERROR_EP_REGISTRY_NOT_ACCESSIBLE, "ePrescription registry could not be accessed.", "", RegistryErrorSeverity.ERROR_SEVERITY_WARNING);
                        responseStatus = AdhocQueryResponseStatus.FAILURE;
                    } else if (prescriptions.isEmpty()) {

                        addErrorMessage(registryErrorList, EhdsiErrorCode.EHDSI_ERROR_EP_NOT_FOUND, "No ePrescriptions are registered for the given patient.", "", RegistryErrorSeverity.ERROR_SEVERITY_WARNING);
                        responseStatus = AdhocQueryResponseStatus.FAILURE;
                    } else {
                ...
                case Constants.PS_CLASSCODE:
                    ...
                    if (psDoc == null || (psDoc.getPDFDocumentMetaData() == null && psDoc.getXMLDocumentMetaData() == null)) {
                        ...
                        addErrorMessage(registryErrorList, EhdsiErrorCode.EHDSI_ERROR_PS_NOT_FOUND, "No patient summary is registered for the given patient.", "", RegistryErrorSeverity.ERROR_SEVERITY_WARNING);
                        responseStatus = AdhocQueryResponseStatus.SUCCESS;
                    } else {
                ...
                case Constants.MRO_CLASSCODE:
                    ...
                    if (mro == null || (mro.getPDFDocumentMetaData() == null && mro.getXMLDocumentMetaData() == null)) {
                        ...
                        addErrorMessage(registryErrorList, EhdsiErrorCode.EHDSI_ERROR_DOCUMENT_NOT_FOUND, "No MRO summary is registered for the given patient.", "", RegistryErrorSeverity.ERROR_SEVERITY_WARNING);
                        responseStatus = AdhocQueryResponseStatus.SUCCESS;
                    } else {
                ...
                case Constants.ORCD_MEDICAL_IMAGES_CLASSCODE:
                    ...
                    if (orCDDocumentMetaDataList == null) {
                        addErrorMessage(registryErrorList, EhdsiErrorCode.EHDSI_ERROR_EP_REGISTRY_NOT_ACCESSIBLE, "orCD registry could not be accessed.", "", RegistryErrorSeverity.ERROR_SEVERITY_WARNING);
                        responseStatus = AdhocQueryResponseStatus.FAILURE;
                    } else if (orCDDocumentMetaDataList.isEmpty()) {
                        addErrorMessage(registryErrorList, EhdsiErrorCode.EHDSI_ERROR_ORCD_NOT_FOUND, "There is no original clinical data of the requested type registered for the given patient.", "", RegistryErrorSeverity.ERROR_SEVERITY_WARNING);
                        responseStatus = AdhocQueryResponseStatus.SUCCESS;
                    } else {
                ...
                default:
                    addErrorMessage(registryErrorList, EhdsiErrorCode.EHDSI_ERROR_UNKNOWN_SIGNIFIER, "Class code not supported for XCA query(" + classCodeValue + ").", "", RegistryErrorSeverity.ERROR_SEVERITY_ERROR);
                    responseStatus = AdhocQueryResponseStatus.SUCCESS;
                    break;
            }
    ...
    private void retrieveDocumentSetBuilder(RetrieveDocumentSetRequestType request, SOAPHeader soapHeader,
        ...
        processLabel:
        {
            ...
            if (!SAML2Validator.isConsentGiven(patientId, countryCode)) {
                addErrorOMMessage(omNamespace, registryErrorList,
                        EhdsiErrorCode.EHDSI_ERROR_NO_CONSENT,
                        EhdsiErrorCode.EHDSI_ERROR_NO_CONSENT.getDescription(),
                        "",
                        RegistryErrorSeverity.ERROR_SEVERITY_ERROR);
                break processLabel;
            }
...
//                }
                ...
                addErrorOMMessage(omNamespace, registryErrorList,
                        EhdsiErrorCode.EHDSI_ERROR_ORCD_NOT_FOUND,
...
//            }
                    ...
                    if (!checkIfOnlyWarnings(registryErrorList)) {
                        ...
                        while (errors.hasNext()) {
                            ...
                            if (StringUtils.startsWith(errorCode.getAttributeValue(QName.valueOf("errorCode")), "45")) {
                                ...
                                addErrorOMMessage(omNamespace, registryErrorList,
                                        EhdsiErrorCode.EHDSI_ERROR_TRANSCODING_ERROR,
                                        EhdsiErrorCode.EHDSI_ERROR_TRANSCODING_ERROR.getDescription(),
                                        "",
                                        RegistryErrorSeverity.ERROR_SEVERITY_ERROR);
        ...
        if (failure) {
            ...
            while (errors.hasNext()) {
                ...
                OMElement errorCode = errors.next();
                logger.error("Error: '{}'-'{}'", errorCode.getText(), errorCode.getAttributeValue(QName.valueOf("errorCode")));
                if (!StringUtils.equals(EhdsiErrorCode.EHDSI_ERROR_TRANSCODING_ERROR.getCode(), errorCode.getAttributeValue(QName.valueOf("errorCode")))) {
                    errors.remove();
                }
            }
        }
            ...
            switch (classCodeValue) {
                case Constants.EP_CLASSCODE:
                    addErrorMessage(registryErrorList,
                            EhdsiErrorCode.EHDSI_ERROR_EP_NOT_FOUND,
                ...
                case Constants.PS_CLASSCODE:
                    addErrorMessage(registryErrorList,
                            EhdsiErrorCode.EHDSI_ERROR_PS_NOT_FOUND,
                ...
                default:
                    addErrorMessage(registryErrorList,
                            EhdsiErrorCode.EHDSI_ERROR_DOCUMENT_NOT_FOUND,
