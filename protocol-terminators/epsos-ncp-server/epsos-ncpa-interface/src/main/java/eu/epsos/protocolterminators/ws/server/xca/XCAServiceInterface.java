...
public interface XCAServiceInterface {
     ...
     * @throws Exception
     */
    AdhocQueryResponse queryDocument(AdhocQueryRequest pRPA_IN201305UV02, SOAPHeader sh, EventLog eventLog) throws Exception;
     ...
     * @throws Exception
     */
    void retrieveDocument(RetrieveDocumentSetRequestType pRPA_IN201305UV02, SOAPHeader sh, EventLog eventLog, OMElement response) throws Exception;
}
