...
public class XcaEpListIT extends ClientGenericIT {
    ...
    public void testQueryEP() {
        ...
        permissions.add("4");
        permissions.add("10");
        assertions = getAssertions(permissions, REQ_FOLDER + "PT_CLIENT_XCA_EP_#0.xml", XSPARoleDeprecated.LICENSED_HCP);
    ...
    public void testQueryEPInsRights() {
        ...
        permissions.add("4");
        assertions = getAssertions(permissions, REQ_FOLDER + "PT_CLIENT_XCA_EP_#3.xml", XSPARoleDeprecated.LICENSED_HCP);
    ...
    public void testQueryNoEP() {
        ...
        permissions.add("4");
        permissions.add("10");
        assertions = getAssertions(permissions, REQ_FOLDER + "PT_CLIENT_XCA_EP_#4.xml", XSPARoleDeprecated.LICENSED_HCP);
