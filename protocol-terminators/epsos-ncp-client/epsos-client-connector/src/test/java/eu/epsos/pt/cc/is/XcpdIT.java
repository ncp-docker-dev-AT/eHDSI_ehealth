...
public class XcpdIT extends ClientGenericIT {
    ...
    public void testQuery() {
        assertions = getAssertions(REQ_FOLDER + "PT_CLIENT_XCPD_#0.xml", XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryInsRights() {
        this.assertions = hcpAssertionCreate(new ArrayList<>(0), XSPARole.DEPRECATED_PHYSICIAN);
    ...
    public void testQueryMinAccur() {
        this.assertions = getAssertions(epr, XSPARole.DEPRECATED_PHYSICIAN);
