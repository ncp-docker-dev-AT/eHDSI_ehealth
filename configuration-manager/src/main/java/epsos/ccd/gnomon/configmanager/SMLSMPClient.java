...
public class SMLSMPClient {
	 ...
	 *
	 * @param countryCode
	 *            The lowercase two-letter country code (ISO 3166-1 alpha-2)
	 * @param documentType
	 *            The document type. Its format is given by the Document
	 *            Identifiers defined in the CP-eHealthDSI-002 for SMP/SML
	 *            capabilities.
	 * @throws SMLSMPClientException
	 *             For any error (including not found)
	 */
	public void lookup(String countryCode, String documentType) throws SMLSMPClientException {
		try {
            ...
            sendAuditQuery(smp, smpemail, ncp, ncpemail, country, localip, remoteip,
	 ...
	 *
	 * @param extension
	 *            the XML extension as a Document
	 */
	 ...
	 *
	 * @param ks
	 *            The truststore containing the certificate used by SMP server
	 *            to sign SMP files.
	 ...
	 *
	 * @param smpClient
	 *            The Dynamic Discovery Client ready to be used
	 * @param participantIdentifierValue
	 *            The SMP Participant Identifier
	 * @param documentType
	 *            The SMP Document Identifier
	...
	public static void sendAuditQuery(String sc_fullname, String sc_email, String sp_fullname, String sp_email,
		...
		try {
			...
			L.error("Error sending audit for eHealth SMP Query");
		}
	}
