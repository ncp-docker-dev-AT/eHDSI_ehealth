...
public class UdpClientTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(UdpClientTest.class);

    public static void main(String[] args) throws Exception {

        ProtocolMessage m = new ProtocolMessage(10, 5, "2009-08-14T14:12:23.115Z",
                "localhost", new StringLogMessage("<atna></atna>"), "IHE_XDS",
                "ATNALOG", "1234");
