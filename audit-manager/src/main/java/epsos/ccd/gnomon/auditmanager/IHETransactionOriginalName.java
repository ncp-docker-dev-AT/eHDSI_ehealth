 ...
 * EHDSI-194:   SMP::Push
 */
public enum IHETransactionOriginalName {

    IDENTIFICATION_SERVICE_FIND_IDENTITY_BY_TRAITS("Cross Gateway Patient Discovery"),
    PATIENT_SERVICE_LIST("Cross Gateway Query"),
    ...
    IHETransactionOriginalName(String c) {
        code = c;
    }
