...
JDK_JAVA_OPTIONS="$JDK_JAVA_OPTIONS --add-opens=java.xml.crypto/org.jcp.xml.dsig.internal.dom=ALL-UNNAMED"
JDK_JAVA_OPTIONS="$JDK_JAVA_OPTIONS --add-opens java.xml/com.sun.org.apache.xerces.internal.jaxp=ALL-UNNAMED"
