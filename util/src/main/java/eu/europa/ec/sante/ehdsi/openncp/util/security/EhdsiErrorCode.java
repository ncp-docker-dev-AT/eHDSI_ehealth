...
public enum EhdsiErrorCode {
    ...
    EHDSI_ERROR_GENERIC(5000, "Generic business error code"),
    EHDSI_ERROR_CONNECTION_NOT_POSSIBLE (5000, "The Country of Treatment (Country B) is unable to contact the Patient Country of Affiliation."),

    // 01. Ensure Health Professional (HP) Identification, Authentication and Authorization
    EHDSI_ERROR_HPI_GENERIC (5000, "The code can be used for HPI errors when no other HPI business code applies."),
    EHDSI_WARNING_HPI_GENERIC(5000, "The code can be used for HPI warnings when no other HPI business code applies."),

    EHDSI_ERROR_HPI_NO_INFORMATION(5000, "No information has been provided about the HP."),
    EHDSI_ERROR_HPI_INSUFFICIENT_INFORMATION(5000, "Information provided about the HP is insufficient"),
    EHDSI_ERROR_HPI_HAI_NO_INFORMATION(5000, "No information has been provided about the Health Authorities Institutions and/or Healthcare Provider Organisation (HCPO) ."),
    EHDSI_ERROR_HPI_POC_NO_INFORMATION(5000, "No information has been provided about the organisation or healthcare facility where the HP is providing the treatment - Point of Care (PoC)"),
    EHDSI_ERROR_HPI_AUTHENTICATION_NOT_RECEIVED(5000, "HP authentication method has not been received by the Country of Affiliation"),

    // 02. Ensure Patient Identification

    EHDSI_ERROR_PI_GENERIC(5000, "The code can be used for PI errors when no other PI business code applies."),
    EHDSI_WARNING_PI_GENERIC(5000, "The code can be used for PI warnings when no other PI business code applies."),

    EHDSI_ERROR_PI_NO_MATCH(5000, "The identification and authentication used in the Country of Treatment (Country B) are not correctly provided or does not match any existing patient."),
    EHDSI_ERROR_PI_MULTIPLE_MATCHES(5000, "The identification and authentication used in the Country of Treatment (Country B) match multiple patients, instead of only one patient."),

    // 05. Make Patient Summary available to HP

    EHDSI_ERROR_PS_GENERIC(5000, "The code can be used for PS errors when no other PS business code applies."),
    EHDSI_WARNING_PS_GENERIC(5000, "The code can be used for PS warnings when no other PS business code applies."),

    EHDSI_ERROR_PS_MISSING_BASIC_SECTIONS(5000, "Any or all of the 5 basic sections are missing, and no reason is communicated for this missing."),
    EHDSI_WARNING_PS_MISSING_BASIC_DATA(5000, "Any or all of the basic data set is missing."),
    EHDSI_WARNING_PS_MISSING_EXPECTED_MAPPING(5000, "A needed code mapping is missing."),
    EHDSI_ERROR_PS_PDF_FORMAT_NOT_PROVIDED(5000, "A PDF has not been provided."),
