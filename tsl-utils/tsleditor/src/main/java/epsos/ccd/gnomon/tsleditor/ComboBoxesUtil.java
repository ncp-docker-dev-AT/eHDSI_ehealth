...
public class ComboBoxesUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ComboBoxesUtil.class);
    ...
    static {
        ...
        try {
            ...
            logger.info("Can't load file at path: " + file.getAbsolutePath() + " Using default values...");
            defaultLanguagesInitialization();
            defaultIdentifiersInitialization();
            defaultStatusInitialization();
        } catch (Exception e) {
