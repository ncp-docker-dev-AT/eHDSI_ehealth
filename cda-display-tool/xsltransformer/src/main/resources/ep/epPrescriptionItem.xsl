    ...
    <xsl:template name="epPrescriptionItemDetails">
        ...
        <table>
            ...
            <form name="DISPENCE_FORM" method="post">
                    ...
                    <td colspan="3">
                        <xsl:call-template name="show-text">
                            <xsl:with-param name="txt"
                                            select="n1:entryRelationship[@typeCode='RSON']/n1:observation[n1:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.5'] ]/n1:text"/>
                        </xsl:call-template>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>
                        <span class="td_label"><!--  Dispensed Package Size:-->
                            <h1>DISPENSED Package Size:</h1>
                            <xsl:call-template name="show-displayLabels">
                    ...
                    <td>
                        ...
                        <xsl:variable name="measureExists">
                            <xsl:call-template name="check-unitMeasures">
                                <xsl:with-param name="code" select="$unitMeasure"/>
                            </xsl:call-template>
                        </xsl:variable>
