...
import epsos.ccd.carecom.tsam.synchronizer.database.*;
...
public class SubsequentSynchronization extends SynchronizeProcedure {
    ...
    public void execute() {
        ...
        // local repository.
        Set<Long> valueSetIds = new HashSet<>();
        ...
        for (Long valueSetId : valueSetIds) {
            ...
            Set<Long> codeSystemConceptIds = new HashSet<>();
            ...
            List<Long> conceptIdsAsList = new ArrayList<>(codeSystemConceptIds);
